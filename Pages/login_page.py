...
class LoginPage(BasePage):
    ...
    def register_new_user(self, browser):
        browser.find_element_by_css_selector("a#login_link ").click()
        browser.find_element_by_css_selector("input#id_registration-email.form-control").send_keys("vas@gmail.com")
        browser.find_element_by_css_selector("input#id_registration-password1.form-control").send_keys("12345local")
        browser.find_element_by_css_selector("input#id_registration-password2.form-control").send_keys("12345local")
